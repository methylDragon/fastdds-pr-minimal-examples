        ...
        eprosima::fastrtps::types::DynamicType_ptr dyn_type)
{
    ...
    DynamicType_ptr pub_dyn_type = builder->build();
    TypeSupport m_type(new eprosima::fastrtps::types::DynamicPubSubType(pub_dyn_type));
    ...
    subscriber_->readers_[reader] = pub_dyn_type;
    eprosima::fastrtps::types::DynamicData_ptr data(
        eprosima::fastrtps::types::DynamicDataFactory::get_instance()->create_data(pub_dyn_type));
